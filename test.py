...
def ValidateSegmentation(args):
    ...
    args.savedir = args.savedir + '_' + args.file_root + '_epoch_' + str(args.max_epochs) + '_lr_' + str(args.lr) + '/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="LEVIR", help='Data directory | LEVIR | SYSU | WHU')
