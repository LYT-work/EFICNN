...
from compare.subnets.layers import * # UnetConv2
from compare.subnets.init_weights import init_weights
from compare.subnets.swin_block import *
from compare.subnets.lightmodel import *
...
class TCDNet(nn.Module): ## 64,32----128,64--DIM=96,CI=128
