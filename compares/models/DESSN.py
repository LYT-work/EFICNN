...
class ADConv(nn.Module):  # Asymmetric Double Convolution
...
class DEM(nn.Module):  # Difference enhancement module
...
class SSAM(nn.Module):  # spatial-spectral attention module
